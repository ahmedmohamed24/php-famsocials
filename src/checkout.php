<?php
session_start();
if(isset($_GET["id"]) && isset($_GET["plan"]) && isset($_GET["planPrice"])){
    ...
    if(empty($planId) || empty($plan)|| empty($planPrice)){
        ...
        if ($res==="null" || $res ===null) {
            ...
            switch ($plan) {
                ...
                break;
                default:
                    die("<script>alert('Some Error has been Occurred ')</script>");
                ...
                <div class="card p-5" style="">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item my-1">
                            ...
                            <button class=" ml-2 btn btn-outline-info" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <li class="list-group-item"><strong>Price</strong> : <span class="text-primary high-plan"><?php echo($price); ?></span><span class="text-primary premium-plan d-none ml-4"><?php echo(2* +$price); ?></span></li>
                        <li class="list-group-item"><input required type="text" name="link-profile" class="form-control" placeholder="Enter the Link" id="link-profile">
