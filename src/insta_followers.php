        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="headerRightContainer text-center">
                    <img src="images/instagram .svg" alt="instagram logo icon">
                </div>
            </div>
        </div>
    </div>
...
<main class="my-5">
    <h1 class="main-heading text-center text-orange">Instagram
        <svg height="50px" viewBox="0 0 512 512.00038" width="50px" xmlns="http://www.w3.org/2000/svg"
    ...
    <p class="main-text container-lg container-md text-center">Followers on Instagram can improve your brand’s
        engagement numbers. When you buy Instagram Followers you get more engagement on your profile which means more
        reputation. Instagram Followers are a good metric to measure your success.</p>
</main>
