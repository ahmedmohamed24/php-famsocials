            ...
            <div class="col-md-6 col-lg-6">
                <div class="headerRightContainer text-center">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        viewBox="0 0 564.452 564.452" style="enable-background:new 0 0 564.452 564.452;"
                        xml:space="preserve" fill="#d63031">
                        <g>
                            <g>
                                <path
                                    d="M282.229,0C126.359,0,0.003,126.357,0.003,282.228c0,155.867,126.356,282.224,282.226,282.224
                                ...
                                <path
                                    d="M221.334,112.924c2.791,1.683,5.792,2.027,8.984,1.041c3.203-0.992,5.465-2.954,6.807-5.89
                                ...
                                <path
                                    d="M140.224,154.614c-3.723-2.965-7.159-4.36-10.292-4.184c-3.133,0.173-5.779,1.618-7.933,4.321
                                ...
                                <path
                                    d="M420.031,167.005c3.231-0.042,6.618-1.691,10.17-4.948c3.517-3.218,5.427-6.395,5.748-9.512
                                ...
                                <path
                                    d="M282.229,398.436c-50.528,0-93.509-32.26-109.507-77.31H42.21C60.89,436.78,161.402,525.377,282.229,525.377
                                ...
                                <polygon points="83.801,304.743 93.134,314.074 102.45,304.743 115.648,304.743 115.648,291.549 124.975,282.228 115.648,272.895
                                    ...
                                    70.609,304.743 		" />
                                <path
                                    d="M318.551,232.612v11.765c0,3.241,2.641,5.888,5.883,5.888h11.764c3.231,0,5.878-2.646,5.878-5.888v-11.765
                                    c0-3.239-2.646-5.875-5.878-5.875h-11.764C321.191,226.732,318.551,229.373,318.551,232.612z" />
                                <path
                                    d="M283.262,263.121c-4.274,0-8.207,1.256-11.602,3.314c1.062-0.329,2.159-0.551,3.314-0.551
                                ...
                                <path
                                    d="M235.476,209.09c-15.837,0-28.674,12.831-28.674,28.671v95.575c0,15.835,12.831,28.666,28.674,28.666h95.575
...
<main class="my-5">
    ...
    <p class="main-text container-lg container-md text-center">Views on Instagram can improve your brand’s engagement
        numbers. When you buy Instagram Views you get more engagement on your profile which means more reputation.
        Instagram Views are a good metric to measure your success.</p>
</main>
