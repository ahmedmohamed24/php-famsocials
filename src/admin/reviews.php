...
?>
    <tr>
    <th scope="row"><?php echo($review['name']); ?></th>
    <td><?php echo($review['review']); ?></td>
    <td><?php echo($review['stars']); ?></td>
    <td><button class="btn btn-warning updateReview" item-data="<?php echo($review['id']); ?>">Approve</button></td>
    <td><button class="btn btn-danger deleteReview" item-data="<?php echo($review['id']); ?>">Delete</button></td>
